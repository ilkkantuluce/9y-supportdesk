...
class AdminFormController extends ParentController{
    public function formAdmin() {
        return $this->view('admin/auth/form', [
    ...
    public function postAdmin() {
        ...
        return redirect()->route('admin/form/form')->with('createdIssue', $createdIssue->key);
    }
}
